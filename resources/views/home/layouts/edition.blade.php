        ...
        @foreach($common['versions'] as $k=>$version)
            <li class="hover-card-{{$k+1}}">
                ...
                <h3 id="hover-card-button-{{$k+1}}" style="border-bottom: 0;border-top:1px solid #ccc;margin-top:10px;" hidden>
                    ...
                    @endif
                    @if($version['code']=='free')
                        <button type="button" class="btn btn-danger margin-top-25 bg-none bg-red border-color-red width-60 height-50px font-size-16  style-ellipsis-1 border-radius-0">立即试用</button>
                    @else
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content font-weight" style="min-width: 500px;">
