...
(function($){
	...
	Page.prototype.setStyle=function(){
		...
		this.obj.find('a.prevPage').css({'width':s.prevNextWidth,'font-size':s.fontSize+'px','height':s.height+'px','line-height':s.height+'px'});
		this.obj.find('a.nextPage').css({'width':s.prevNextWidth,'font-size':s.fontSize+'px','height':s.height+'px','line-height':s.height+'px'});
	
		this.obj.find('a.turndown').css({'margin-left':'5px','display':'inline-block','width':'24px','height':s.height+'px','line-height':s.height+'px'});
		
		this.obj.find('span.current').css({'display':'inline-block','height':s.height+'px','line-height':s.height+'px','border':'1px solid #E21B14','color':s.currentColor,'vertical-align':'middle','width':s.pageWidth+'px'});
		
		this.obj.find('span.disabled').css({'display':'inline-block','height':s.height+'px','line-height':s.height+'px','color':s.disableColor,'background':s.disableBackColor,'border':'1px solid '+s.borderColor,'vertical-align':'middle','font-size':s.fontSize+'px','width':s.prevNextWidth+'px'});
		...
		this.obj.find('.tcdNumber').css({'width':s.pageWidth-2+'px','height':s.height+'px','line-height':s.height+'px'});
